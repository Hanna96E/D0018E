...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 16, 2021 at 06:55 PM
...
INSERT INTO `itemList` (`listId`, `orderId`, `userId`, `productId`, `amount`) VALUES
(1, 1, 2, 2, 3),
(3, 1, 3, 1, 5),
(4, 1, 3, 2, 1),
(5, 2, 3, 2, 3),
...
(8, 'mystery flavor', 1000, 2, 'A lot, take it before its gone', 'unkown', 'http://cdn.shopify.com/s/files/1/0315/2173/4789/products/BlueKetchup_1024x.jpg?v=1614091139'),
(9, 'blue ketchup', 12, 5, 'its blue', 'blue tomatos', 'http://2.bp.blogspot.com/-A4RTJNbUAfA/UWB9bse-3tI/AAAAAAAACPc/yOk6JEW6ynA/s1600/blue.jpg');
...
(9, 8, 'name', 'name', 'name@name.com', 'member'),
...
--
ALTER TABLE `itemList`
  MODIFY `listId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=172;
